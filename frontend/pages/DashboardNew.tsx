    ...
    return (
        <div className="dashboard-new">
            ...
            {kpis?.tickets?.byStatus?.find((s: any) => s._id === 'aberto')?.count > 0 && (
                <div
                    ...
                    style={{
                        ...
                        alignItems: 'center',
                        gap: '20px',
                        boxShadow: '0 12px 24px rgba(238, 93, 80, 0.25)',
                        cursor: 'pointer',
                        transition: 'transform 0.2s'
                    }}
                >
                    <div style={{ backgroundColor: 'rgba(255,255,255,0.25)', padding: '12px', borderRadius: '12px', display: 'flex' }}>
                        <AlertTriangle size={24} color="white" />
                    </div>
                    <div>
                        <h3 style={{ margin: '0 0 4px 0', fontSize: '1.2rem', fontWeight: 750, letterSpacing: '-0.5px' }}>
                            Atenção: {kpis?.tickets?.byStatus?.find((s: any) => s._id === 'aberto')?.count} novos chamados pendentes!
                        </h3>
                        <p style={{ margin: 0, opacity: 0.95, fontSize: '1rem' }}>
                            Existem solicitações aguardando sua análise. Clique para resolver.
                        </p>
                    </div>
                    <div style={{ marginLeft: 'auto', backgroundColor: 'white', padding: '10px', borderRadius: '50%', display: 'flex', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
                        <TrendingUp size={20} color="#EE5D50" />
                    </div>
                </div>
            )}
            ...
            <div className="kpi-grid-new">
                ...
                <div
                    className="kpi-card-new warning"
                ...
                <div
                    className="kpi-card-new secondary"
