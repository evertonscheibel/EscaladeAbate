...
const SlaughterClosurePage: React.FC = () => {
    ...
    const handleClose = async () => {
        ...
        try {
            ...
            alert(error.response?.data?.message || 'Erro ao fechar');
        } finally {
            setSaving(false);
        }
    };
    ...
    const handleSaveRow = (updatedLine: SlaughterClosureLine) => {
        if (!closure) return;
            ...
            <header className="closure-header">
                <div className="header-left">
                    ...
                    <div className="header-title">
                        <h1>Fechamento Oficial SIF - {format(new Date(date!), 'dd/MM/yyyy', { locale: ptBR })}</h1>
