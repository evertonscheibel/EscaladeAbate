...
export const ManagerQueue: React.FC = () => {
    ...
    const filteredTickets = tickets.filter(t => {
        if (filterMode === 'mine') return t.assignedTo && (typeof t.assignedTo === 'object' ? t.assignedTo._id === user?.id : t.assignedTo === user?.id);
        if (filterMode === 'unassigned') return !t.assignedTo;
        return true;
    });
