        ...
        <div className="manager-metrics-container">
            <header className="page-header">
                <div className="page-title-group">
                    ...
                    <p className="page-subtitle">Visão global do sistema e performance da equipe</p>
                </div>
                                        ...
                                        <tr key={agent.email}>
                                            ...
                                            <td className="text-center">
                                                <div className="priority-distribution">
                                                    ...
                                                    {agent.totalTickets === 0 && <span style={{ color: 'var(--text-muted)' }}>-</span>}
                                                </div>
                                            </td>
                                            ...
                                            <td className="text-center" style={{ color: 'var(--danger)', fontWeight: 800 }}>{agent.slaBreachedTickets || 0}</td>
