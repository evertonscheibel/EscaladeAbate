...
const Candidates: React.FC = () => {
    ...
    return (
        <div className="candidates-page">
                                        ...
                                        <tr key={candidate._id}>
                                            <td>
                                                <div className="candidate-info-cell">
                                                    ...
                                                    <div>
                                                        <span className="candidate-name">{candidate.fullName || 'Sem Nome'}</span>
                                            ...
                                            <td>
                                                <div className="vaga-info">
                                                    ...
                                                    <small>{candidate.education?.replace('_', ' ') || 'Escolaridade não inf.'}</small>
                                                </div>
                                            </td>
            ...
            {showModal && (
                <CandidateModal
                    candidateId={(selectedCandidateId as string) || undefined}
                    onClose={() => {
                        setShowModal(false);
                        setSelectedCandidateId(null);
                        loadCandidates();
