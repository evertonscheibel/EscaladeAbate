    ...
    const loadData = async () => {
        try {
            ...
            const promises: Promise<any>[] = [
                ticketService.getAgentMetrics({ agentId: filterAssignedTo || undefined })
            ];
        ...
        <div className="agent-metrics-container">
            <header className="page-header">
                <div className="page-title-group">
                    ...
                    <p className="page-subtitle">Acompanhe seus indicadores e tickets atribuídos</p>
                </div>
                        ...
                        <table className="tickets-table">
                            ...
                            <tbody>
                                {assignedTickets.map((ticket) => (
                                    <tr key={ticket._id}>
                                        <td style={{ fontWeight: 800 }}>#{ticket._id.slice(-6)}</td>
                                        <td>
