...
export interface Ticket {
    ...
    status: 'aberto' | 'em_andamento' | 'pendente_cliente' | 'pendente_interno' | 'resolvido' | 'fechado';
    requester: any;
    assignedTo?: any[];
    sector?: string;
    asset?: any;
...
export const ticketService = {
    ...
    async getAgentMetrics(params?: any) {
        const response = await api.get('/tickets/metrics/agents', { params });
        return response.data;
    },
