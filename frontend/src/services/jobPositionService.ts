...
export const jobPositionService = {
    ...
    create: (data: Partial<JobPosition>) => api.post<JobPosition>('/job-positions', data),
    update: (id: string, data: Partial<JobPosition>) => api.put<JobPosition>(`/job-positions/${id}`, data),
    delete: (id: string) => api.delete<{ message: string }>(`/job-positions/${id}`)
};
