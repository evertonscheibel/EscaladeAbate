...
// Exportar PDF
router.get('/schedules/:id/pdf', authorize('admin', 'tecnico'), exportSchedulePdf);

// --- Cadastro de Peças ---
router.get('/pieces', getPieces);
router.post('/pieces', authorize('admin'), createPiece);
router.put('/pieces/:id', authorize('admin'), updatePiece);
router.delete('/pieces/:id', authorize('admin'), deletePiece);
