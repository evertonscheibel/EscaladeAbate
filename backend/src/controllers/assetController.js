...
export const getAssets = async (req, res, next) => {
    try {
        ...
        const result = await paginate(Asset, query, options);
...
export const updateAsset = async (req, res, next) => {
    try {
        ...
        const allowedFields = [
            'description', 'type', 'brand', 'model', 'serialNumber',
            'location', 'acquisitionDate', 'purchaseDate', 'purchaseValue',
            'warrantyExpiration', 'status', 'responsible', 'assignedTo',
            'department', 'ipAddress', 'macAddress', 'hostname', 'anydeskId',
            'specs', 'lastMaintenanceDate', 'nextMaintenanceDate',
            'maintenanceInterval', 'notes', 'customFields',
            'isNetworkDevice', 'linkedDocuments'
        ];
        const updateData = {};
