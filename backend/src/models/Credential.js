...
if (!ENCRYPTION_KEY || ENCRYPTION_KEY.length < 32) {
    throw new Error('CREDENTIAL_ENCRYPTION_KEY inválida ou ausente. Deve ter pelo menos 32 caracteres.');
}
const IV_LENGTH = 16;
...
credentialSchema.plugin(softDeletePlugin);

// Índices Compostos para Performance
credentialSchema.index({ category: 1, status: 1 });
